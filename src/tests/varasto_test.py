...
class TestVarasto(unittest.TestCase):
    ...
    def test_luo_negatiivinen_tilavuus(self):
        varasto = Varasto(-1)
        self.assertGreaterEqual(varasto.tilavuus, 0)

    def test_luo_negatiivinen_saldo(self):
        varasto = Varasto(0, -1)
        self.assertGreaterEqual(varasto.saldo, 0)
    ...
    def test_oikein_formatoitu(self):
